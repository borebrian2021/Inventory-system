...
namespace SAINA.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult delete_invoice(int id)
        {
            ...
            return RedirectToAction("home_details", "home", new
            {
                id = id,
  ...
  .Sum();
        ...
        public IActionResult infor(int id)
        {
            ...
            view.Particulars = _context.Particulars.Where(x => x.id == id);
   ...
   .Sum();
        ...
        public IActionResult delete_item(int id, int c_id, int d_id)
        {
            ...
            return RedirectToAction("deliveries", "home", new
            {
                id = d_id,
        ...
        public IActionResult deliveries(int id)
        {
            ...
            QRCodeData qrCodeData = qrGenerator.CreateQrCode("http://www.supremesai.co.ke/home/infor/" + id,
